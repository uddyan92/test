...
*** Test Cases ***
4.6.10 STC OS UPGRADE CREATE NEW JOB-EXECUTION TIME LATER-SELECT DATE 
    ...
    Wait for the loading icon to disappear
    Create device values with active os upgrade status device select date "${osupgrade.create_new}"
