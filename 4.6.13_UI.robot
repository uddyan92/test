...
*** Test Cases ***
4.6.13 STC OS UPGRADE CREATE NEW JOB-MDT/TCN Mapping duplicates
    ...
    Wait for the loading icon to disappear
    Create device values with active os upgrade status mdt rows duplicate "${osupgrade.create_new}" and "${osupgrade.mdt_params}"
    Log to Console   "Select Platform Model: 'ASR-920-24TZ-M' \n Select Device Role: 'UPE92' \n Select Release Software Version: '3.18.5SP'\n File Transfer Protocol: 'FTP' \n mdt_number: 123 \n Approval Status: 'Approved' \n mutilselect_device: 'STC-ASR920-1' and the params for next rows mdt mapping mdt_number: 111 \n Approval Status: 'Approved' \n mutilselect_device: 'STC-ASR920-2'"
    Wait for the loading icon to disappear
